...
import online.letmesleep.androidapplication.MainActivity;
import online.letmesleep.androidapplication.R;

public class RtmpSenderActivity extends AppCompatActivity {
...
//_rtmpSessionMgr.Start("rtmp://175.25.23.34/live/12345678");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rtmp_sender);
        ...
        public void onClick(DialogInterface dialog, int which) {
            switch (which) {
                case AlertDialog.BUTTON_POSITIVE: {// "确认"按钮退出程序
                    ...
                    RtmpSenderActivity.this.finish();
